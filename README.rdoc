...
Create a model called comment in your project and add the following:
  ...
  class Comment < ActiveRecord::Base
    include MuckComments::Models::Comment
  end
...
Override the comments controller to change the the security model.  For example:
  ...
  class CommentsController < Muck::CommentsController
    ...
    # Each model that implements 'include MuckComments::Models::Comment' can override 'can_comment?' to 
...
For a given model add 'include MuckComments::Models::Comment'

  class Blog < ActiveRecord::Base
    include MuckComments::Models::Comment
  end

'include MuckComments::Models::Comment' will automatically track the count, but you will need to add a column to your table called comment_count:
...
For example, for an object 'activity' that include MuckComments::Models::Commentable create a partial 'activities/_comment.html.erb'.  The contents might look like this:
